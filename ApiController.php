            ...
            if ($validator->fails()) {
                ...
                if (!$user) {
                    ...
                    for ($i = 01; $i <= $currentDay; ++$i) {
                        ...
                        $userData = UserAttendance::whereDate('intime', $startdate)
                    ...
                    $response = ['success' => true, 'message' => 'Attendance get successfully.', 'data' => $notAttendance];
                }
            }
            $date = Carbon::now()->subDays(10);
            // RequestLogs::whereDate('created_at', '<', $date)->delete();
                    ...
                    if ($faceData) {
                        ...
                        if ($faceVerify) {
                            ...
                            if (isset($faceIdentity->error)) {
                                ...
                                if ($distance && $faceIdentity->isIdentical || $faceIdentity->confidence > 0.05) {
                                    $offices = explode(',', $user->office_id);
