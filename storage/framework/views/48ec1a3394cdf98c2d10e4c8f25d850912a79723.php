...
#my_camera{
 ...
 border: 1px solid black;
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-pane1" class="tab-pane active">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo e(url('admin/mark_attendance')); ?>" method="post" enctype="multipart/form-data">
                                             <?php echo csrf_field(); ?>
   ...
   <script type="text/javascript" src="<?php echo e(asset('admin/plugins/jquery/webcam.min.js')); ?>" ></script>
...
$(document).on('change','#batch_id',function(){
  var batchid= $('#batch_id').val();
   ...
   $.ajax({
           type: "POST",
            url:"<?php echo e(url('admin/checkattendancedetails')); ?>",
           data: { "_token": "<?php echo e(csrf_token()); ?>","batchid" : batchid },
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azureuser/dutyParLatest/resources/views/admin/userbatchdetail/attendance.blade.php ENDPATH**/ ?>