                                ...
                                <div id="tab-pane1" class="tab-pane active">
                                  <div class="card-body pad">
                                    <div class="tab-content">
                                         ...
                                         <?php if(Auth::user()->role_type==5 || Auth::user()->role_type==4 || Auth::user()->role_type==3 || Auth::user()->role_type==1): ?>
                                
                                        <form action="<?php echo e(url('admin/batchfilter')); ?>" method="post" 
                                     ...
                                     <div class=col-md-3>
                                       ...
                                       <div class=col-md-1>
                                        ...
                                        <label></label>
                                        <div>
                                          <a href="<?php echo e(url('admin/pdf')); ?>" type="button"
    ...
    $('#frameworks2').multiselect({
     ...
     $('#frameworks11').multiselect({
        ...
        $(document).on('change','#teacher',function(){
          ...
          $.ajax({
                  url: "<?php echo e(url('admin/teacher')); ?>",
                  method: 'post',
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azureuser/dutyParLatest/resources/views/admin/attendenceDetail/filterbatch.blade.php ENDPATH**/ ?>