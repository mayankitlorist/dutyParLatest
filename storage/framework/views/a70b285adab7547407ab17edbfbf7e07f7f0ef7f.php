                                    ...
                                    <div class='row'>
                                     <div class=col-md-4>
                                            ...
                                            <select class="form-control" name="batch" id="batchid">
                                                ...
                                                <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($batche->batch_id); ?>"><?php echo e($batche->batch_name); ?></option>
...
<script type="text/javascript" src="https://code.jquery.com/jquery-1.7.1.min.js"></script>
    ...
    <script>
        ...
        $(document).on('click', '.batchsubmit', function(){
           ...
           if(batchid){
                $.ajax({
                        url: "<?php echo e(url('admin/batchstudent')); ?>",
                        method: 'post',
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azureuser/dutyParLatest/resources/views/admin/testdash.blade.php ENDPATH**/ ?>