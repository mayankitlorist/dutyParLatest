                    ...
                    <div class="card card-outline card-info">
                        ...
                        <!-- /.card-paragraph -->
                                ...
                                <div id="tab-pane1" class="tab-pane active">
                                  ...
                                  <form action="<?php echo e(url('admin/ownerbatchfilter')); ?>" method="post"
                                            ...
                                            <div>
                                              <label class="form-group">Teacher Name*</label>
                                                <select class="frameworks11" id="teacher" name="teacher" >
                                                  ...
                                                  <option value="<?php echo e($teachers ->id); ?>">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.2/js/bootstrap-select.min.js"></script>
    ...
    buttonWidth: '100%'
     ...
     $(document).on('change','#teacher',function(){
          ...
          $.ajax({
                  url: "<?php echo e(url('admin/getteachers')); ?>",
                  method: 'post',
          ...
          $.ajax({
                  url: "<?php echo e(url('admin/gettrainer')); ?>",
                  method: 'post',
                  data: { "_token" : "<?php echo e(csrf_token()); ?>",
                     "trainer": trainerid,
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azureuser/dutyParLatest/resources/views/admin/attendencereport/attendencereport.blade.php ENDPATH**/ ?>